...
# Scrapy settings for s_cities project
#
...
SPIDER_MODULES = ['s_cities.spiders']
NEWSPIDER_MODULE = 's_cities.spiders'


# Crawl responsibly by identifying yourself (and your website) on the user-agent
#USER_AGENT = 's_cities (+http://www.yourdomain.com)'
...
SPIDER_MIDDLEWARES = {
   'sm_save_html_source.raw.HTMLSourceMiddleware': 1,
}
